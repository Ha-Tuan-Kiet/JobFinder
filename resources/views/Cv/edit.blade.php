...
{{--                                    <li id="confirm"><strong>Preview</strong></li>--}}
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <input type="text" name="title" id="title" placeholder="Title CV" value="{{$cv->title}}"/>
                                        <label><b>Contact Information</b></label>
                                        <input type="text" name="position_apply" id="position_apply"  value="{{$cv->position_apply}}"/>
                                        <input type="number" name="phone" id="phone" placeholder="Phone"  maxlength="10" value="{{$cv->phone}}"/>
                                        <input type="email" name="email" id="email" placeholder="Email" value="{{$cv->email}}" />
                                        <div class="row">
                                            <label><b>Gender:</b></label>
                                            <div class="col-lg-6 col-md-6">
                                                <select name="gender">
                                                    <option value="Male"{{$cv->gender =="Male" ? 'selected' :''}}>
                                                        Male
                                                    </option>
                                                    <option value="Female"{{$cv->gender =="Female" ? 'selected' :''}}>
                                                        FeMale
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <label for="cars"><b>Choose careers:</b></label>
                                            <select name="career_id" id="career_id">
                                                @foreach($career_id as $career)
                                                    <option value="{{ $career->id }}">{{$career->name}}</option>
                                                @endforeach
{{--                                                <option value="{{$cv->career_id}}" > </option>--}}
                                            </select>
                                        </div>
...
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div> <img style="width:400px;height:400px;" src="http://127.0.0.1:8000/assets/img/updatecv.png" class="fit-image"> </div>--}}
{{--                                    <button type="submit"  class="next action-button" >Submit</button>--}}
